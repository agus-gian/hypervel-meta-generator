...
namespace AugustPermana\HypervelMetaGenerator\Commands;
...
class MakeMetaModel extends Command
{
    ...
    protected ?string $signature = 'make:metadata {--model= : The model to create metadata for}';
    protected string $description = 'Create metadata system for existing model';
...
use AugustPermana\HypervelMetaGenerator\Models\MetaModel;
...
class {{class}} extends MetaModel
{
     ...
     *
     * @return \Hypervel\Database\Eloquent\Relations\BelongsTo
     */
