...
class CleanOrphanedMeta extends Command
{
    ...
    protected ?string $signature = 'metadata:clean-orphaned {--model= : The model to clean orphaned metadata for}';
    protected string $description = 'Clean orphaned metadata records where the parent record no longer exists';
